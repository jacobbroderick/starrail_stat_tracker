...
class LevelMaterials(object):
    ...
    def GetLevelUpMaterialCounts(trace_type: str,character_type: int ) -> None:
        ...
        if character_type == CharacterTypes.FIVE_STAR_TYPE:
            if trace_type == LevelUpTypes.BASIC_ATTACK_TRACES:
